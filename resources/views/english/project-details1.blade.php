...
<head>
    <!-- Title  -->
    <title>EASYNO MEDIA MARKETING AGENCY - Service 1</title>
...
<body class="home-main-crev main-bg ">
    ...
    <main class="main-bg rtl">
        ...
        <header class="proj-header1 " >
                ...
                <div class="row d-flex align-items-center" >
                    <div class="col-12">
                        <div class="caption md-mb50">
                            <h1>تصميم الهوية والعلامة التجارية</h1>
                            <p  style="text-align: justify; text-justify: inter-word;">علامتك التجارية ليست فقط رمزًا يحدد مشروعك أو عملك ، بل هي أيضًا مفهوم يعكس أهدافك وما يمكن أن يحققه عملك. لذا نصمم علامتك التجارية بكل إحترافية و نعتبرها بمثابة أداة تسويقية لك، تعكس اتساق عملك واحترافه وتميزك عن المنافسين في مجالك.
                            </p>
                        </div>
                    </div>
            ...
            <div style="background-size: 100%" class="bg-img" data-background="assets/imgs/works/1.png"></div>
        </header>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 offset-lg-1">
                        <div class="text">
                            <p class="mb-50">Won’t seasons, appear days them stars replenish divided. All second forth. Him place was seas man and gathering creepeth called fly. Them sea place lights, midst bearing fourth above.</p>
                            <div class="row">
                                <div class="col-md-6">
                                    <ul class="rest dot-list">
                                        <li class="mb-15">Brand Development</li>
                                        <li class="mb-15">Art Direction</li>
                                ...
                                <div class="col-md-6">
                                    <ul class="rest dot-list">
                                        ...
                                        <li class="mb-15">Graphic Design</li>
                                        <li class="mb-15">Brand Development</li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="back-image bg-img parallaxie" data-background="assets/imgs/works/projects/1/5.jpg"></div>

                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mt-50">
                            <h5 class="fw-200">Working collaboratively with brands and agencies worldwide. Designing and developing websites and applications with a focus on interaction, motion and visual experience.</h5>
                        </div>
                    </div>
                </div>
    ...
    <section class="call-action-img">
        <div class="container">
            <div class="sec-bg-img bg-img parallaxie" data-background="assets/imgs/works/projects/2/1.jpg"></div>
            <div class="sec-lg-head section-padding">
                <div class="row ontop">
                    <div class="col-11 d-flex align-items-center">
                        ...
                        <div class="ml-auto">
                            <a href="project-details2.html" class="butn-circle d-flex align-items-center text-center m-auto">
...
<!-- Mirrored from ui-themez.smartinnovates.net/items/geekfolio/dark/project-details1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Oct 2023 10:43:37 GMT -->
</html>
