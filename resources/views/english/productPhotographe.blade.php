                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6 offset-lg-1">
                                <div class="product-info">
                                    <div class="top-info">
                                        <h6 class="main-color4">DH 500.00</h6>
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <h4 class="line-height-1">Rent a Studio for an Exceptional Photoshoot</h4>
                                            </div>
                                        </div>
                                        <div class="text mt-30">
                                            <p>We offer our dedicated photo studio for all your projects and achievements. Feel free to contact us if you want to rent our photo studios at a reasonable price.</p>
                                            <br>
                                            <p>You can rent our photo studio day by day and adapt it to various needs. You can rent this location as part of an audiovisual project, whatever its nature. From corporate video to commercial advertising to a music video or interviews, the possibilities are numerous. With the high-quality equipment available, professional photographers can unleash their imagination.</p>
                                        </div>
                                    </div>
                                    <div class="prod-order pt-30 pb-30 mt-50 bord-thin-top bord-thin-bottom">
                                        <div class="d-flex align-items-center">
                                            <div class="ml-auto w-100">
                                                <a href="{{ route('en-confirmeOrder',['id'=>'photographeSession']) }}" class="butn butn-md butn-bord w-100 text-center">
