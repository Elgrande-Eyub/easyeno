                                ...
                                <div class="product-info">
                                    <div class="top-info">
                                        ...
                                        <div class="text mt-30">
                                            <p>نضع تحت تصرفك استوديو التصوير الخاص بنا  لجميع مشاريعك وإنجازاتك. لا تتردد في الاتصال بنا إذا كنت ترغب في استئجار استوديوهات التصوير الخاصة بنا بسعر معقول.

                                            </p>
                                            <br>
                                            <p>    يمكن استئجار استوديو التصوير الخاص بنا يومًا بعد يوم ويتكيف مع الاحتياجات المختلفة. يمكنك استئجار هذا الموقع كجزء من مشروع سمعي بصري، مهما كانت الطبيعة. من فيديو الشركة إلى إعلان تجاري إلى فيديو موسيقي أو مقابلات، الاحتمالات عديدة. بفضل المعدات عالية الجودة المتاحة، يمكن لمحترفي الصور إطلاق العنان لخيالهم.</p></p>
                                        </div>
                                    ...
                                    <div class="prod-order pt-30 pb-30 mt-50 bord-thin-top bord-thin-bottom">
                                        <div class="d-flex align-items-center">
                                            <div class="ml-auto w-100">
                                                <a href="{{ route('ar-confirmeOrder',['id'=>'photographeSession']) }}" class="butn butn-md butn-bord w-100 text-center" >
