            ...
            <main class="main-bg" >
                ...
                <section class="about-intro section-padding contact-crev">
                    <div class="container">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5 valign rest rtl" >
                                <div class="cont" style="margin-right: 1rem">
                                    <h2 class="d-rotate wow">
                                        <span class=" rotate-text">شريكك التقني الأمثل</span>
                                    </h2>
                                    <div class="feat mt-80" style="padding:0.5rem">
                                        <div class="item-flex d-flex align-items-center mb-50 wow fadeIn" data-wow-delay=".4s">
                                            ...
                                            <div class="cont mr-30">
                                                ...
                                                <p class="fz-15">نتخصص في التسويق، مما يوفر لك الوقت والموارد الثمينة، مما يجعلنا اختيارك المثالي</p>
                                            </div>
                                        </div>
                                        <div class="item-flex d-flex align-items-center mb-50 wow fadeIn" data-wow-delay=".4s">
                                            <div>
                                            ...
                                            <div class="cont mr-30">
                                                <h6>الجودة</h6>
                                                <p class="fz-15">أفكارك نحولها إلى واقع ضمن استراتيجية تسويقية لنمو عملك والاستمرار في الحصول على الحصة الأكبر في السوق أمام المنافسين                                                </p>
                                            </div>
                                        </div>
                                        <div class="item-flex d-flex align-items-center wow fadeIn" data-wow-delay=".8s">
                                            ...
                                            <div class="cont mr-30">
                                                <h6>الميزانية</h6>
                                                <p class="fz-15">إدارتنا المالية عالية الجودة تضمن أن ميزانيتك تكون استثمارًا ناجحًا</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 rest">
                                <div class="imgs md-mb50">
                                    <div class="img1">
                                        <div class="o-hidden">
                                            <div class="imago wow">
                                                <img  src="{{ asset('assets\imgs\index\about\Target.webp') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="img2">
                                        <div class="o-hidden">
                                            <div class="imago wow">
                                                <img  src="{{ asset('assets\imgs\index\about\Rocket.webp') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="bg-pattern bg-img" data-background="assets/imgs/patterns/bg-lines-1.svg" style="background-image: url(&quot;assets/imgs/patterns/bg-lines-1.svg&quot;);"></div>
                ...
                <section class="serv-box section-padding pb-0 rtl contact-crev">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="serv-item lg-pad md-mb50 radius-5 wow fadeIn" data-wow-delay=".8s">
                                    ...
                                    <p class="fz-14">للعلامات التجارية والتصميم الذي يترك انطباعًا دائمًا ويتقاطع مع جوهر هويتك.</p>
                                    <div class="crv-more">
                                        <a href="#" class="mt-30 ls1 fz-12 text-u" style="display: flex; justify-content: end;">اقرأ المزيد<svg
                                                width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col-lg-4">
                                <div class="serv-item lg-pad radius-5 wow fadeIn" data-wow-delay="1.2s">
                                    ...
                                    <p class="fz-14">يتفوق فريق الإبداع لدينا في كتابة وإخراج وتحرير المحتوى الإبداعي باستخدام أحدث التقنيات وأفكار مبتكرة لإنشاء ذكريات جمهور دائمة.</p>
                                    <div class="crv-more">
                                        <a href="#" class="mt-30 ls1 fz-12 text-u" style="display: flex; justify-content: end;">اقرأ المزيد<svg
                                                width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                ...
                <section class="works thecontainer  ">
                    <div class="panel mt-30" >
                        <div class="item">
                            <div class="img" style="text-align: center">
                                <img   src="{{ asset('assets\imgs\index\services\branding.webp') }}" alt="">
                            </div>
                    ...
                    <div class="panel mt-30">
                        <div class="item" >
                            <div class="img">
                                <img  src="{{ asset('assets\imgs\index\services\socialMedia.webp') }}" alt="">
                            </div>
                    ...
                    <div class="panel mt-30">
                        <div class="item" >
                            <div class="img">
                                <img  src="{{ asset('assets\imgs\index\services\websiteCreation.webp') }}" alt="">
                            </div>
                            <div class="cont d-flex align-items-end">
                                <div>
                    ...
                    <div class="panel mt-30">
                        <div class="item" >
                            <div class="img">
                                <img  src="{{ asset('assets\imgs\index\services\digitalMarketing.webp') }}" alt="">
                            </div>
                            <div class="cont d-flex align-items-end">
                                <div>
                    ...
                    <div class="panel mt-30">
                        <div class="item" >
                            <div class="img">
                                <img  src="{{ asset('assets\imgs\index\services\videoMarketing.webp') }}" alt="">
                            </div>
                            <div class="cont d-flex align-items-end">
                                <div>
                    ...
                    <div class="bg-pattern bg-repeat bg-img opacity-1" data-background="assets/imgs/patterns/dots.png" style="background-image: url(&quot;assets/imgs/patterns/dots.png&quot;);">
                    </div>
                            ...
                            <div class="col-lg-6 md-mb50">
                                <div class="imgs mb-80">
                                    <div class="img1 main-color3 wow fadeIn" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
                                        <img src="{{ asset('assets/imgs/index/company/company1.webp') }}" alt="">
                                    </div>
                                    <div class="img2 wow fadeInLeft" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInLeft;">
                                        <img src="{{ asset('assets/imgs/index/company/company.webp') }}" alt="">
                                    </div>
                                </div>
                            </div>
