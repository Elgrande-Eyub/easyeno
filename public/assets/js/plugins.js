...
! function(e) {
    e.fn.hover3d = function(t) {
        ...
        return this.each(function() {
            ...
            o.css({ perspective: r.perspective + "px", transformStyle: "preserve-3d" }), i.css({ perspective: r.perspective + "px", transformStyle: "preserve-3d" }), a.css({ position: "absolute", top: 0, left: 0, bottom: 0, right: 0, transform: "translateZ(1px)", "z-index": 9 }), o.on("mouseenter", function() { return t() }), o.on("mousemove", function(e) { return s(e) }), o.on("mouseleave", function() { return n() })
        })
    }
}(jQuery);
...
jQuery(document).ready((function(s) {
    ...
    function d(s) {
        ...
        if (s.parents(".cd-headline").hasClass("type")) {
            ...
            e.addClass("selected").removeClass("waiting"), setTimeout((function() { e.removeClass("selected"), s.removeClass("is-visible").addClass("is-hidden").children("i").removeClass("in").addClass("out") }), 500), setTimeout((function() { l(i, 150) }), 1300)
    ...
    function r(i, e, a, t) {
        if (i.removeClass("in").addClass("out"), i.is(":last-child") ? a && setTimeout((function() { d(c(e)) }), n) : setTimeout((function() { r(i.next(), e, a, t) }), t), i.is(":last-child") && s("html").hasClass("no-csstransitions")) {
            var l = c(e);
            h(e, l)
        }
    }
    ...
    s(".cd-headline.letters").find("b").each((function() {
        ...
        var i = s(this);
        if (i.hasClass("loading-bar")) a = t, setTimeout((function() { i.find(".cd-words-wrapper").addClass("is-loading") }), 800);
